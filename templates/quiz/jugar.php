...
if(isset($_GET['siguiente'])){//Ya esta jugando
    ...
    if($_GET['respuesta']=="A menudo"){
        $_SESSION['correctas'] = $_SESSION['correctas'] + 2;
    }
    else if($_GET['respuesta']=="A veces"){
            ...
            <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="get">
                <div class="opciones">
                    <label for="respuesta1" onclick="seleccionar(this)" class="op1">
                        ...
                        <input type="radio" name="respuesta" value="Nunca" id="respuesta1" required>
                    </label>
                    <label for="respuesta2" onclick="seleccionar(this)" class="op2">
                        <p><?php echo $preguntaActual['opcion_b']?></p>
                        <input type="radio" name="respuesta" value="A veces" id="respuesta2" required>
                    </label>
                    <label for="respuesta3" onclick="seleccionar(this)" class="op3">
                        <p><?php echo $preguntaActual['opcion_c']?></p>
                        <input type="radio" name="respuesta" value="A menudo" id="respuesta3" required>
                    </label>
                </div>
                <div class="boton">
